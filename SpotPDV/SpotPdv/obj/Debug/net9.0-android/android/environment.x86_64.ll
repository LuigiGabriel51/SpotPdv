...
@dso_cache = dso_local local_unnamed_addr global [44 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: librealm-wrappers.so
		ptr null; void* handle
	}, ; 6
	%struct.DSOCacheEntry {
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [24 x i8] c"com.companyname.spotpdv\00", align 16
...
@.DSOCacheEntry.10_name = private unnamed_addr constant [21 x i8] c"librealm-wrappers.so\00", align 16
